...
df_hourly = pd.read_csv('../results/gb_hourly_windows_performance-imputed-no-outliers.csv', index_col=0)
df_daily = pd.read_csv('../results/gb_daily_windows_performance-imputed-no-outliers.csv', index_col=0)
